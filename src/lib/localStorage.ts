...
export type LocalStorageSetter<K extends LocalStorageKey> = (newVal: LocalStorageValue<K> | ((prev: LocalStorageValue<K>) => LocalStorageValue<K>) ) => void;
    ...
    (newVal: LocalStorageValue<K> | ((prev: LocalStorageValue<K>) => LocalStorageValue<K>)) => {
      if (typeof newVal === "function") {
        setValue((prev: LocalStorageValue<K>) => {
          const newValue = newVal(prev ?? localStorageSchema[key].defaultValue);
